//g++ -D__LITTLE_ENDIAN__ -I /usr/include/stk/ -o test_quicksort_drums test_quicksort_drums.cpp -lstk -lpthread -lasound -lm


#include "quick_sort_drum.cpp"
...
int main(){
    ...
    for(int i=0;i<N;i++){
        ...
        a_drum.loudness = (1.0*i)/(3.0*N) + 1.0/3.0;//some kinda varying loudness to make it less boring
...
*/
    ...
    quick_sort_the_place(drums, 0, drums.size()-1, output, fps);
